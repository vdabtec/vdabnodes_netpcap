...
import com.lcrc.af.exe.ExecuteCommand.CommandReplyListener;


public class NetworkSource_DEP extends  AnalysisSource implements CommandReplyListener {
	static {
		IPProtocolType.getEnum();
	}
	private ExecuteCommand c_Exe;
	private int c_OS;
	...
	private void restartMonitoring(){
		...
		if (isRunning()){
			...
			c_Exe = new ExecuteCommand(cmd, 0L, 0L, null, this);
		}
	}
	...
	public void handleCommandError(Object[] params, String line) {
		publish(new AnalysisEvent(this, "STDERR",line));
